...
<body>
    ...
    <form action="/proveedor" method="post">
        ...
        <input type="text" name="nombre_completo" value="{{ old('nombre_completo') }}"><br>

        <label for="num_telefono">Numero de telefono:</label><br>
        <input type="text" name="num_telefono" value="{{ old('num_telefono') }}"><br>
        ...
        <input type="text" name="nombre_empresa" value="{{ old('nombre_empresa') }}"><br>
